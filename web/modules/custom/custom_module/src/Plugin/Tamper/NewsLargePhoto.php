...
/**
 * Plugin implementation for newslargephoto.
 *
 * @Tamper(
 *   id = "newslargephoto",
 *   label = @Translation("News Large Photo"),
 *   description = @Translation("This will take image URL & create Media"),
 *   category = "Media"
 * )
 */
class NewsLargePhoto extends TamperBase {
  ...
  public function isMediaExist($filename) {
    ...
    $query->condition('m.bundle', 'article_featured_image', '=');
    $query->range(0, 1);
