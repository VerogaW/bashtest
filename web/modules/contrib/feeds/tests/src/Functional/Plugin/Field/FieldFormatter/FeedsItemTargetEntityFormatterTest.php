...
class FeedsItemTargetEntityFormatterTest extends FeedsItemFormatterTestBase {
  ...
  public function testFeedsItemTargetEntityFormatter() {
    ...
    $expected_rendered_oneliner_label = '<div class="field__label">Witty one liner label</div>';
    ...
    $this->assertContains($expected_rendered_oneliner_label, (string) $rendered_content);
    $this->assertContains($expected_rendered_oneliner_field, (string) $rendered_content);
  }
